...
function freezeValue<T extends TypeDef>(v: ValueTypeOf<T>, def: T): ValueTypeOf<ReadonlyOf<T>> {
  if (v == null || def.type === TypeDefType.Literal) {
    ...
    return v as ValueTypeOf<ReadonlyOf<T>>;
  }
